...
void setup() {
    Serial.begin( 115200 ); /// Serial for motor monitoring
}

int test_array[ SAMPLE_SIZE ];
unsigned long t_for_time;
        
void loop() {
// TEST CODE FOR FFTITTIES
t_for_time = micros();
Serial.print( t_for_time );
for( int i = 0; i < SAMPLE_SIZE; i++ ){
    test_array[ i ] = analogRead( A0 );
    delay( 30 );
}

t_for_time = micros() - t_for_time;
t_for_time = 128000000 / t_for_time;

FFT( test_array, SAMPLE_SIZE, t_for_time );
delay( 1000 );
